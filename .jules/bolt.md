...
## 2026-06-21 - [Draft7Validator Caching]
**Learning:** Repetitive schema validation creates significant overhead from re-instantiating jsonschema validators, which involves disk I/O, JSON parsing, and object initialization.
**Action:** Cache the `Draft7Validator` instance in a module-level dictionary keyed by the schema name to prevent redundant overhead on subsequent validations.
