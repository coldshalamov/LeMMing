...
## 2026-06-29 - [Draft7Validator Caching]
**Learning:** Instantiating jsonschema Draft7Validator instances repeatedly inside hot loops causes severe performance degradation due to redundant JSON parsing, disk I/O, and object initialization overhead.
**Action:** Cache Draft7Validator instances at the module level (e.g., in a dictionary keyed by schema name) to ensure they are parsed and initialized only once.
