...
## 2026-06-05 - [JSON Schema Validator Caching]
**Learning:** Compiling jsonschema definitions into validators (e.g. `Draft7Validator(schema)`) is computationally expensive.
**Action:** Cache the compiled validator instances keyed by schema name to avoid re-instantiating them for repeated validations, which yields a ~6.5x speedup.
