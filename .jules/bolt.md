...
## 2026-07-12 - [Optimizing load_agent Caching]
...
## 2026-07-12 - [ModelRegistry Caching]
...
## 2026-07-12 - [Defensive Caching]
**Learning:** Returning cached objects directly can lead to unintended mutations, as previously highlighted in ModelRegistry caching.
**Action:** Always protect cached objects from mutation by returning deep copies (e.g., `copy.deepcopy`) when retrieving them from the cache.
