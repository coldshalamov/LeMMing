...
## 2024-05-27 - [Batch Disk I/O Writes]
**Learning:** When updating shared state across multiple agents in a single tick (like credits), writing incrementally per agent causes severe O(N) disk I/O bottlenecks.
**Action:** Batch disk I/O write operations at the end of the tick loop, conditionally checking if the list of processed entities is not empty before writing.
