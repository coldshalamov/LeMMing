...
## 2026-03-14 - Interactive Elements inside Custom Modals Lack Focus Indicators
**Learning:** Custom interactive elements within modals (like grid selection cards and filter chips) often lack default browser focus indicators due to heavy styling, leading to poor keyboard accessibility.
**Action:** Add explicit `focus-visible` utility classes (e.g., `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan`) to these elements to ensure they receive a clear focus ring only when navigated via keyboard.
