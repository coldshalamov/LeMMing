...
export const MOCK_AGENTS: AgentInfo[] = [
  {
    ...
    description:
      "Maintains high-level system coherence and strategic planning.",
    model: "gpt-4-turbo",
...
export const MOCK_GRAPH: OrgGraph = {
  overmind: {
    can_read: ["frontend_dev", "backend_dev", "qa_bot"],
    tools: ["read_file"],
  },
...
export const MOCK_MESSAGES: OutboxEntry[] = [
  ...
  },
  {
    ...
    kind: "response",
    payload: {
      text: "API endpoint for navigation is ready at /api/nav/structure.",
    },
    tags: ["api"],
  },
  {
    ...
    kind: "report",
    payload: {
      text: "Found a regression in login flow when navigation changes.",
    },
    tags: ["bug"],
  },
];
