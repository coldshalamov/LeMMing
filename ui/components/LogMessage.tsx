...
export function LogMessage({ payload, kind }: LogMessageProps) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full min-w-0">
      <div
        className="flex items-start gap-2 cursor-pointer group rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan focus-visible:ring-offset-1 focus-visible:ring-offset-neo-bg"
      ...
      {expanded && (
        <div className="relative pl-6 pr-2 pb-2 text-[10px] font-mono text-gray-500 overflow-x-auto group/code">
          <button
            onClick={handleCopy}
            className={clsx(
              "absolute top-4 right-4 p-1.5 rounded border border-white/10 transition-all z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan focus-visible:ring-offset-1 focus-visible:ring-offset-neo-bg",
              isCopied
