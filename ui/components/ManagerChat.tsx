                    ...
                    >
                        ...
                        <form onSubmit={handleSend} className="p-3 bg-black/40 border-t border-white/5 flex gap-2 items-end">
                            ...
                            <button
                                ...
                                title={isSending ? "Sending message..." : !inputValue.trim() ? "Please enter a message to send" : "Send message"}
                                className={clsx(
                                    ...
                                    isSending ? "cursor-wait" : !inputValue.trim() ? "cursor-not-allowed" : "cursor-pointer"
                                )}
                            >
