                    ...
                    >
                        ...
                        <form onSubmit={handleSend} className="p-3 bg-black/40 border-t border-white/5 flex gap-2 items-end">
                            ...
                            <button
                                ...
                                title={!inputValue.trim() ? "Please type a message to send" : isSending ? "Sending..." : "Send message"}
                                aria-label={isSending ? "Sending message..." : "Send message"}
                                className={clsx(
                                    "p-2 text-white rounded-lg transition-colors h-[38px] flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black",
                                    !inputValue.trim() || isSending
                                        ? "bg-brand-purple/50 opacity-50 cursor-not-allowed"
                                        : "bg-brand-purple hover:bg-purple-600"
                                )}
                            >
