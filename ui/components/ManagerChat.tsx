                    ...
                    >
                        ...
                        <form onSubmit={handleSend} className="p-3 bg-black/40 border-t border-white/5 flex gap-2 items-end">
                            ...
                            <button
                                ...
                                title={!inputValue.trim() ? "Type a message to send" : isSending ? "Sending message..." : "Send message"}
                                aria-label={isSending ? "Sending message..." : "Send message"}
                                className="p-2 bg-brand-purple text-white rounded-lg hover:bg-purple-600 aria-disabled:opacity-50 aria-disabled:cursor-not-allowed aria-disabled:hover:bg-brand-purple transition-colors h-[38px] flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                            >
