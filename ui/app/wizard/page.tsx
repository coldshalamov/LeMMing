                      ...
                      {formData.permissions.tools.length > 0 && (
                        <div className="mt-4 flex flex-wrap gap-2">
                          {formData.permissions.tools.map((tool) => (
                            <div
                              key={tool}
                              className="pl-3 pr-1 py-1 bg-brand-cyan/10 border border-brand-cyan/30 rounded-full text-xs text-brand-cyan flex items-center gap-2 group/chip"
                            >
                              <Check size={12} />
                              {tool}
                              <button
                                ...
                                className="p-1 hover:bg-brand-cyan/20 rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan"
                                aria-label={`Remove ${tool} capability`}
                                title={`Remove ${tool}`}
                              >
                                <X size={12} className="opacity-70 group-hover/chip:opacity-100" />
                              </button>
                            </div>
                          ))}
                        </div>
