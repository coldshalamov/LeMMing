        ...
        <div className="flex items-center gap-3">
          <Link href="/" className="hover:text-brand-cyan transition-colors">
            <h1 className="font-bold text-xl tracking-tight">
              LeMMing <span className="text-white/30 font-light">WIZARD</span>
            </h1>
          </Link>
        </div>
              ...
              >
                ...
                {stepIdx === 1 && (
                  <div className="space-y-4">
                    ...
                    <div className="p-4 rounded border border-neo-border bg-neo-surface/50">
                      ...
                      >
                        &quot;You are a LeMMing agent operating in a multi-agent
                        organization...&quot;
                      </p>
                      <textarea
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...
                              schedule: {
                                ...formData.schedule,
                                run_every_n_ticks: parseInt(e.target.value),
                              },
                            })
                          }
                          className="w-full bg-neo-surface border border-neo-border p-3 rounded text-white focus:border-brand-cyan focus:outline-none"
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...
                              schedule: {
                                ...formData.schedule,
                                phase_offset: parseInt(e.target.value),
                              },
                            })
                          }
                          className="w-full bg-neo-surface border border-neo-border p-3 rounded text-white focus:border-brand-cyan focus:outline-none"
                    ...
                    <div className="p-4 bg-neo-surface/30 rounded border border-neo-border flex items-center gap-4">
                      <div className="flex-1 text-sm text-gray-300">
                        ...
                        <code className="text-brand-cyan">
                          tick % {formData.schedule.run_every_n_ticks} =={" "}
                          {formData.schedule.phase_offset %
                            formData.schedule.run_every_n_ticks}
                        </code>
                        .
                        <br />
                        It has a{" "}
                        {(
                          (1 / formData.schedule.run_every_n_ticks) *
                          100
                        ).toFixed(0)}
                        % duty cycle.
                      </div>
                      ...
                      >
                        {TOOLS.map((tool) => (
                          <button
                            ...
                            className={clsx(
                              "px-3 py-1.5 rounded border text-xs font-mono transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan flex items-center gap-2",
                ...
                <div className="flex justify-between pt-8 border-t border-white/5">
                  ...
                  {stepIdx < STEPS.length - 1 ? (
                    ...
                    <button className="px-6 py-2 rounded bg-brand-lime text-black font-bold hover:bg-lime-400 flex items-center gap-2 shadow-[0_0_20px_rgba(132,204,22,0.4)]">
