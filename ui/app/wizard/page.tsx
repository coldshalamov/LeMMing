...
export default function WizardPage() {
  ...
  const [formData, setFormData] = useState<WizardState>({
    ...
    model: {
      key: modelOptions[0] ?? "gpt-4o-mini",
      temperature: 0.2,
      max_tokens: 2048,
    },
        ...
        <div className="flex items-center gap-2">
          <Link href="/" className="hover:text-brand-cyan transition-colors">
            <h1 className="font-bold text-lg tracking-tight">
              LeMMing{" "}
              <span className="text-white/30 font-light text-sm">WIZARD</span>
            </h1>
          </Link>
        </div>
      ...
      <div className="flex-1 flex overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            workflow_description: e.target.value,
                          })
                        }
                        className="w-full bg-neo-surface border border-neo-border p-3 rounded text-white focus:border-brand-cyan focus:outline-none h-28"
                        placeholder="Describe how this agent works (inputs, outputs, routine)..."
                      />
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            model: { ...formData.model, key: e.target.value },
                          })
                        }
                        className="w-full bg-neo-surface border border-neo-border p-3 rounded text-white focus:border-brand-cyan focus:outline-none"
                      >
                    ...
                    <div className="p-4 rounded border border-neo-border bg-neo-surface/50">
                      ...
                      <textarea
                        ...
                        className="w-full mt-2 bg-black/20 border border-white/10 p-2 text-xs font-mono text-gray-300 h-48 focus:outline-none focus:border-brand-cyan"
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...
                            schedule: {
                              ...formData.schedule,
                              run_every_n_ticks: parseInt(e.target.value, 10),
                            },
                          })
                        }
                        className="w-full bg-neo-surface border border-neo-border p-3 rounded text-white focus:border-brand-cyan focus:outline-none"
                    ...
                    <div className="bg-gradient-to-br from-neo-panel to-neo-surface border border-neo-border rounded-xl overflow-hidden">
                      ...
                      <div className="p-6 border-b border-white/5 bg-black/20 flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="text-xs flex items-center gap-1.5 px-3 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-gray-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan"
                ...
                <div className="flex justify-between pt-8 border-t border-white/5">
                  <button
                    onClick={handleBack}
                    className="px-6 py-2 rounded border border-neo-border text-gray-400 hover:text-white flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan"
                    title={
                      stepIdx === 0
                        ? "Cancel wizard"
                  ...
                  {stepIdx < STEPS.length - 1 ? (
                    <button
                      onClick={handleNext}
                      className={clsx(
                        "px-6 py-2 rounded font-bold flex items-center gap-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan focus-visible:ring-offset-2 focus-visible:ring-offset-neo-panel",
                    ...
                    <button
                      ...
                      className={clsx(
                        "px-6 py-2 rounded font-bold flex items-center gap-2 shadow-[0_0_20px_rgba(132,204,22,0.4)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-lime focus-visible:ring-offset-2 focus-visible:ring-offset-neo-panel",
                        isDeploying
        ...
        <div className="w-1/3 border-l border-neo-border bg-neo-surface flex flex-col items-center justify-center p-8 bg-[url('/grid.svg')]">
          <div className="mb-8 text-center">
            <h3 className="text-white/40 font-mono text-xs tracking-widest uppercase mb-4">
              Live Preview
            </h3>
