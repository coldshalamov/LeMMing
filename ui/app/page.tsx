            ...
            >
              ...
              <div className="p-4 border-b border-white/5 flex justify-between items-start bg-black/20">
                ...
                <button
                  ...
                  className="text-white/20 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan rounded p-1"
                  title="Close"
            ...
            <div className="flex-1 flex items-center justify-center flex-col text-white/20">
              {!agents || agents.length === 0 ? (
                <>
                  ...
                  <Link
                    href="/wizard"
                    className="flex items-center gap-2 px-6 py-3 bg-brand-cyan text-black font-bold rounded hover:bg-cyan-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                  >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-30 pointer-events-auto">
        <div className="flex items-center gap-4 p-2 pl-6 pr-2 bg-black/60 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl">
          ...
          <button
            ...
            title={isTicking ? "Tick execution in progress..." : "Run one tick"}
