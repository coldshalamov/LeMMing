...
export default function Dashboard() {
  ...
  // Handle Escape key to close agent details
  useEffect(() => {
        ...
        <header className="flex items-center justify-between px-6 pt-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="pointer-events-auto flex items-center gap-3">
              ...
              <Link
                href="/wizard"
                className="flex items-center gap-2 px-4 py-2 bg-brand-cyan text-black font-bold rounded shadow-[0_0_15px_rgba(6,182,212,0.3)] hover:bg-cyan-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              >
            ...
            >
              ...
              <div className="p-4 border-b border-white/5 flex justify-between items-start bg-black/20">
                ...
                <button
                  ...
                  className="text-white/20 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan rounded-sm"
                  title="Close"
            ...
            <div className="flex-1 flex items-center justify-center flex-col text-white/20">
              {!agents || agents.length === 0 ? (
                <>
                  ...
                  <Link
                    href="/wizard"
                    className="flex items-center gap-2 px-6 py-3 bg-brand-cyan text-black font-bold rounded hover:bg-cyan-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                  >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-30 pointer-events-auto">
        <div className="flex items-center gap-4 p-2 pl-6 pr-2 bg-black/60 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl">
          ...
          <button
            ...
            disabled={isTicking}
            className={clsx(
              "w-12 h-12 rounded-full flex items-center justify-center hover:scale-105 active:scale-95 transition-transform shadow-lg disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black",
              isTicking
