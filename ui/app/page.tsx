        ...
        <header className="flex items-center justify-between px-6 pt-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="pointer-events-auto flex items-center gap-3">
              ...
              <Link
                href="/wizard"
                className="flex items-center gap-2 px-4 py-2 bg-brand-cyan text-black font-bold rounded shadow-[0_0_15px_rgba(6,182,212,0.3)] hover:bg-cyan-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan"
              >
            ...
            <div className="flex-1 flex items-center justify-center flex-col text-white/20">
              {!agents || agents.length === 0 ? (
                <>
                  ...
                  <Link
                    href="/wizard"
                    className="flex items-center gap-2 px-6 py-3 bg-brand-cyan text-black font-bold rounded hover:bg-cyan-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan"
                  >
