...
def test_cli_provider_environment_sanitization():
    ...
    try:
        with patch("subprocess.run") as mock_run:
            ...
            assert "SECRET_TOKEN_123" not in run_env
    finally:
        del os.environ["SECRET_TOKEN_123"]
