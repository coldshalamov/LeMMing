...
if SECRETS_PATH.exists():
    try:
        with open(SECRETS_PATH) as f:
            # SECURITY: Renamed variable to loaded_secrets to avoid shadowing the built-in
            # python 'secrets' module used for secure constant-time comparisons later in the file.
