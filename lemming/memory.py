...
def get_memory_context(base_path: Path, agent_name: str, max_items: int = 20) -> str:
    ...
    try:
        # Optimization: use os.scandir to evaluate lazily and avoid loading all json
        # files when max_items limits the results
        with os.scandir(memory_dir) as it:
            ...
            # Sort entries to ensure deterministic ordering (cache stability)
