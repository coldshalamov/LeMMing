...
# Bolt: Cache Draft7Validator instances to prevent redundant file I/O, JSON parsing,
# and instantiation overheads during repetitive validations.
...
def _iter_schema_errors(schema_name: str, instance: Any) -> Iterable[Any]:
    ...
    return cast(Iterable[Any], _validator_cache[schema_name].iter_errors(instance))
