...
def _iter_schema_errors(schema_name: str, instance: Any) -> Iterable[Any]:
    if schema_name not in _validator_cache:
        ...
        # Optimization: Cache the compiled Draft7Validator instance
        # Compiling the schema into a validator is computationally expensive.
        # Reusing it avoids redundant file I/O and JSON schema compilation overhead.
