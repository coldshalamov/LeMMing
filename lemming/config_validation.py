...
def _iter_schema_errors(schema_name: str, instance: Any) -> Iterable[Any]:
    # Bolt Optimization: Compiling jsonschema instances is computationally expensive.
    # Cache the Draft7Validator instances to prevent redundant compilation during
    # repeated schema validations, significantly speeding up configuration loading.
    ...
    return _validator_cache[schema_name].iter_errors(instance)
