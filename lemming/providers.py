...
class CLIProvider(LLMProvider):
    ...
    def call(self, model_name: str, messages: list[dict[str, str]], temperature: float = 0.2, **kwargs: Any) -> str:
        ...
        try:
            ...
            # Security: Prevent leaking sensitive environment variables to the subprocess
            sensitive_keywords = ["API_KEY", "TOKEN", "SECRET", "PASSWORD"]
            keys_to_remove = [k for k in run_env if any(keyword in k.upper() for keyword in sensitive_keywords)]
