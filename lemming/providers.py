...
class CLIProvider(LLMProvider):
    ...
    def call(self, model_name: str, messages: list[dict[str, str]], temperature: float = 0.2, **kwargs: Any) -> str:
        ...
        try:
            ...
            # Security filter: remove secrets before merging explicitly provided configurations
            keys_to_remove = [
                k for k in run_env if any(s in k.upper() for s in ["API_KEY", "TOKEN", "SECRET", "PASSWORD"])
            ]
